...
combinedData <- combinedData %>%
  ...
  description = dplyr::case_when(
    medicaidOversight == "Yes" ~ paste('The', agency, 'has oversight over Medicaid.'),
    medicaidOversight == "No" ~ paste('The', agency, 'does not have oversight over Medicaid.'),
    ...
    function updateTooltip(point) {
      tooltip.innerHTML = `
        <div style="padding: 8px;">
          ...
          <b style="color: ${"%s"}; text-align: center !important;">${point.agency}</b><br>
          <i style="font-size: .9em; line-height: .7em; text-align: left !important;">${point.description}<br></i>

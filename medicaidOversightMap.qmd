...
# Create color axis with pattern fills based on your pattern library
color_axis_pattern <- list(
  dataClasses = list(
    list(
      from = "SHO Oversight (SHO designee does not have oversight)",
      to = "SHO Oversight (SHO designee does not have oversight)",
      color = chainlink_pattern,  # Using pattern instead of solid color
      name = "SHO Oversight (SHO designee does not have oversight)"
    ),
  ...
  list(
      from = "No SHO Oversight",
      to = "No SHO Oversight",
      color = triangles_pattern,
      name = "No SHO Oversight"
    ),
    
    list(
      from = "NA | Freestanding",
      to = "NA | Freestanding",
      name = "Freestanding",
      color = parquet_pattern
    ),
  
  
    list(
      from = "NA | Does not have Medicaid",
      to = "NA | Does not have Medicaid",
      name = "Does not have Medicaid",
      color = na_pattern
    ),
...
# Keep your solid color version for comparison/toggle
color_axis_solid <- list(
  dataClasses = list(
    list(
      from = "SHO Oversight (SHO designee does not have oversight)",
      to = "SHO Oversight (SHO designee does not have oversight)",
      color = main_blue,  # Using pattern instead of solid color
      name = "SHO Oversight (SHO designee does not have oversight)"
    ),
    list(
      from = "SHO Oversight",

...
medicaid <- read_excel("updatedMemberData.xlsx")|>
  ...
  mutate( 
    ...
    medicaidOversight = dplyr::case_when(
       ...
       medicaid == "NA - Freestanding" ~ "Freestanding Agency: No S/THO Oversight",
    
    tolower(medicaid) == "no sho oversight" ~ "Umbrella Agency: No S/THO Oversight",
  ...
  #   
  #   str_detect(medicaidOversight, "Umbrella Agency: No S/THO Oversight")  ~ "Umbrella Agency: No S/THO Oversight",
  #   
  #    medicaid == "Data Not Available" ~ "Data Not Available",
  #   
...
combinedData <- combinedData |>
  ...
  dplyr::mutate(colors = dplyr::case_when(
    medicaidOversight == "Freestanding Agency: No S/THO Oversight" ~ icon_accent,
    medicaidOversight == "Umbrella Agency: No S/THO Oversight" ~ main_orange,
  ...
  labels = dplyr::case_when(
    ...
    medicaidOversight == "Umbrella Agency: No S/THO Oversight" |
      medicaidOversight == "Freestanding Agency: No S/THO Oversight" ~ "❌ No S/THO Oversight", 
  ...
  description = dplyr::case_when(
    medicaidOversight == "Freestanding Agency: No S/THO Oversight" & jurisdictionName != "Alabama" ~ paste(' <b>is freestanding</b>, so does not have oversight over Medicaid.'),
    
        medicaidOversight == "Freestanding Agency: No S/THO Oversight" & jurisdictionName == "Alabama" ~ paste(' <b>is freestanding</b> and does not have oversight over Medicaid, but does have oversight of the Children’s Health Insurance (CHIP) Program.'),
    
    medicaidOversight == "Umbrella Agency: No S/THO Oversight" ~ paste(' <b>does not have oversight</b> over Medicaid.'),
...
color_mappings <- list(
  ...
  list(
    group = "Umbrella Agency",
    subgroup = "Umbrella Agency: No S/THO Oversight",
    display_name = "Umbrella Agency: No S/THO Oversight",
  ...
  list(
    ...
    subgroup = "Freestanding Agency: No S/THO Oversight",
    display_name = "Freestanding Agency: No S/THO Oversight",
